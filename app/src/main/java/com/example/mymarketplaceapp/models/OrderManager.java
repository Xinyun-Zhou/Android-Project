...
public class OrderManager {
    ...
    public void createNewOrder(int buyerId, List<CartItem> cartItemList) {
        ...
        orderList.add(new Order(orderList.size(), buyerId, cartItemList, Order.Type.BUY));
        ...
        for (Integer sellerId : sellerIdList) {
            ...
            orderList.add(new Order(orderList.size(), sellerId, soldItemList, Order.Type.SELL));
        }
